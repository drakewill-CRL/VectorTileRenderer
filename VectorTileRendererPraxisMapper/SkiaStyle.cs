...
//NOTE: this class replaces Style.cs, and only attaches values to Skia library components.
namespace VectorTileRendererPraxisMapper
{
    ...
    public class Paint
    {
        ...
        public SKStrokeCap LineCap { get; set; } = SKStrokeCap.Square;
        ...
        public SKTextAlign TextJustify { get; set; } = SKTextAlign.Center;
    ...
    public class Style
    {
        ...
        public SKColor GetBackgroundColor(double zoom)
        {
            ...
            {
                return brush.Paint.BackgroundColor;
            }
        ...
        public Brush ParseStyle(Layer layer, double scale, Dictionary<string, object> attributes)
        {
            ...
            if (layoutData != null)
            {
                if (layoutData.ContainsKey("line-cap"))
                {
                    ...
                    if (value == "butt")
                    {
                        paint.LineCap = SKStrokeCap.Butt;
                    }
                    else if (value == "round")
                    {
                        paint.LineCap = SKStrokeCap.Round;
                    }
                    else if (value == "square")
                    {
                        paint.LineCap = SKStrokeCap.Square;
                    }
                }
